...
class EchoNavHostTest {
    ...
    fun `路由常量正确`() {
        ...
        assertEquals("password_setup?isChangePassword={isChangePassword}", EchoRoutes.PASSWORD_SETUP)
        assertEquals("isChangePassword", EchoRoutes.PASSWORD_SETUP_IS_CHANGE)
        assertEquals("password_setup?isChangePassword=false", EchoRoutes.passwordSetupRoute(false))
        assertEquals("password_setup?isChangePassword=true", EchoRoutes.passwordSetupRoute(true))
